...
if not st.session_state.setup_complete:
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Software Engineer", "Data Engineer", "Quality Assurance Engineer", "Product Manager", "Product Owner"),
            index=("Software Engineer", "Data Engineer", "Quality Assurance Engineer", "Product Manager", "Product Owner").index(st.session_state["position"])
        )

    st.session_state["company"] = st.selectbox(
        "Select a Company",
        ("Amazon", "Wells Fargo", "Goldman Sachs", "Toyota", "United Health Group", "Google", "Mckinsey & Company"),
        index=("Amazon", "Wells Fargo", "Goldman Sachs", "Toyota", "United Health Group", "Google", "Mckinsey & Company").index(st.session_state["company"])
    )
